...
function scrollRevealAboutText() {
  const scrollContainer = document.querySelector('.blurred');
  const aboutTextBlocks = document.querySelectorAll('#about-text');

  function checkVisibility() {
    aboutTextBlocks.forEach(el => {
      ...
      if (isVisible) {
        el.classList.add('img-txt-after');
        el.classList.remove('img-txt-before');
      }
    });
  }
